...
```{r}
greet <- function(person, greeting = "Hello", pleasantry ="you are good") {
  paste(greeting, person, pleasantry)
}
greet("Shakil", greeting = "Howdy", pleasantry ="you are strong")
greet("Shakil", greeting = "Howdy")
greet("Shakil")
```
...
```{r}
style <- function(year) {
  ifelse(year < 1752,"old-style","new-style")
}
